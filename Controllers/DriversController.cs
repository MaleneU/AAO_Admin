...
namespace AAO_AdminPanel.Controllers
{
    public class DriversController : Controller
    {
        ...
        {
            var mySQLDbContext = _context.Driver.Include(d => d.User);
        ...
        public async Task<IActionResult> Create([Bind("DriverID,UserID,Active")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DriverID,UserID,Active")] Driver driver)
        {
